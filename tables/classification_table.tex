...
\cline{2-5}
\textbf{} &
  \multicolumn{2}{p{6.5cm}|}{\vspace{0.5mm} \textbf{On-policy IL: Only data gathered by the current policy is useful for updating it}\vspace{0.5mm}} &
  \multicolumn{2}{p{6.5cm}|}{\vspace{0.5mm}\textbf{Off-policy: Data gathered by any agent is useful for updating the policy}} \\ \hline
\multicolumn{1}{|p{1.8cm}|}{\textbf{Online sampling}\vspace{0.5mm}} &
